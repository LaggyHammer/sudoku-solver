...
class Grid:
    ...
    def place(self, val):
        ...
        if self.cubes[row][col].value == 0:
            ...
            if valid_move(self.model, row, col, val):
                return True
            else:
    ...
    def draw(self):
        ...
        for i in range(self.rows + 1):
            ...
            pygame.draw.line(self.win, (0, 0, 0), (0, i * gap), (i * gap, self.height), thick)
    ...
    def solve(self):
        find = empty_position(self.model)
        if not find:
            return True
        else:
            row, col = find
        ...
        for i in range(1, 10):
            if valid_move(self.model, row, col, i):
...
class Cube:
    ...
    def draw_change(self, win, g=True):
        fnt = pygame.font.SysFont("comisans", 40)
